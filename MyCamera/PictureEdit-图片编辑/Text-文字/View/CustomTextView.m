...
@interface CustomTextView()<UITextViewDelegate, UITextFieldDelegate>
{
...
- (id)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        CGRect borderRect = CGRectMake(0, 0, self.frame.size.width - 24, self.frame.size.height - 24);
...
- (void)layoutSubviews{
    ...
    CGRect borderRect = CGRectMake(0, 0, _borderView.width , _borderView.height);
    UIBezierPath *path = [UIBezierPath bezierPathWithRect:borderRect];
    self.border.path = path.CGPath;
